      ...
      <div className="home">
        ...
        <section className="smarty-programs">
          ...
          <div className="program-cards">
            <div className="program-card"><FaBabyCarriage className="program-icon" /><h3>Kindergarten</h3><p>Creating a safe and welcoming environment for learning.</p></div>
            <div className="program-card"><FaChalkboardTeacher className="program-icon" /><h3>Primary School</h3><p>Encouraging exploration and curiosity through diverse activities.</p></div>
            <div className="program-card"><FaSchool className="program-icon" /><h3>Secondary School</h3><p>Preparing students for future academic challenges and life skills.</p></div>
            <div className="program-card"><FaUserGraduate className="program-icon" /><h3>Preparatory School</h3><p>Fostering essential skills to excel in the next academic level.</p></div>
          </div>
        </section>
