const ProfileInfo = () => {
  return (
    <>
    <div className='ProfileScheduleSection mt-3 px-4 py-3  fs-6  lh-lg m-auto'>
    <div className='fs-5 fw-semibold mb-1'> General </div>
    <div className=' opacity-75  border-bottom border-secondary mb-1'>
      <div className='fs-6 fw-medium'>Date Of Birth</div>
      <div>21.07.2003</div>
    </div>
    <div className=' opacity-75  border-bottom border-secondary mb-1'>
      <div className='fs-6 fw-medium'>Gender</div>
      <div>Girl</div>
    </div>
    <div className=' opacity-75  border-bottom border-secondary mb-1'>
      <div className='fs-6 fw-medium'>Level</div>
      <div>Primary</div>
    </div>
    <div className=' opacity-75  border-bottom border-secondary mb-1'>
      <div className='fs-6 fw-medium'>Grade</div>
      <div>6</div>
    </div>
    ...
    <div className='fs-5 fw-semibold mb-1'> Emergency Info </div>
    <div className=' opacity-75  border-bottom border-secondary mb-1'>
